...
class calendarFeedTests(TestCase):
    ...
    def get_calendar(self):
        ...
        return Calendar(response.content.decode('utf-8'))
    ...
    def test_calendar_entry(self):
        ...
        self.assertEquals(f'{booker}s booking', event.name)
        self.assertEqual(start_date, event.begin.datetime.date())
        self.assertEqual(end_date, event.end.datetime.date())
